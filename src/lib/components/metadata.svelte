<script lang="ts">
	...
	$: metadata = $page.data.metadata
		? {
				...$page.data.metadata,
				title: $page.data.metadata.title + ' | glazk0.dev'
			}
		: {
				title: 'glazk0.dev',
				description: 'Student, Software Developer and Gamer',
				image: CDN_URL + '/assets/banner.webp'
			};
</script>
...
<svelte:head>
	...
	<script src="https://analytics.glazk0.dev/api/script.js" data-site-id="1" async defer></script>
</svelte:head>
